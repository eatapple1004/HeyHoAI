...
const NEST_PREFIXES = ['/nest', '/api/pricing', '/api/credits', '/api/billing', '/api/subscription', '/api/dashboard', '/api/brand-kit', '/api/teams', '/api/affiliate', '/api/recipes', '/api/studio'];
