...
const NEST_PREFIXES = ['/nest', '/api/pricing', '/api/credits', '/api/billing', '/api/subscription', '/api/dashboard', '/api/brand-kit', '/api/teams', '/api/affiliate', '/api/recipes', '/api/studio', '/api/marketplace', '/api/characters', '/api/images', '/api/videos', '/api/visuals', '/api/template-data', '/api/admin/trials', '/api/trial'];
