...
export class ContentsController {
  ...
  async regenerateCaption(@Req() req: any, @Param('id') id: string) {
  ...
  @Post(':id/schedule')
  async schedule(@Req() req: any, @Param('id') id: string, @Body() body: any) {
  ...
  @Post(':id/publish-now')
  @HttpCode(200)
  async publishNow(@Req() req: any, @Param('id') id: string) {
...
export class CharacterPublishingController {
  ...
  @Get('contents')
  async contents(@Req() req: any, @Param('characterId') characterId: string, @Query() q: any) {
  ...
  @Get('publish-jobs')
  async publishJobs(@Req() req: any, @Param('characterId') characterId: string, @Query() q: any) {
