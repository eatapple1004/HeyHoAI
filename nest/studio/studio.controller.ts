...
export class StudioController {
  ...
  @Delete('themes/:id')
  async deleteTheme(@Req() req: any, @Param('id') id: string) {
  ...
  @HttpCode(200)
  async hideRecipe(@Req() req: any, @Param('recipeId') recipeId: string) {
  ...
  async unhideRecipe(@Req() req: any, @Param('recipeId') recipeId: string) {
  ...
  @HttpCode(200)
  async setGlobalThemeItem(@Req() req: any, @Param('slug') slug: string, @Body() body: any) {
  ...
  @HttpCode(200)
  async hideTheme(@Req() req: any, @Param('slug') slug: string) {
  ...
  async unhideTheme(@Req() req: any, @Param('slug') slug: string) {
