...
export class CharactersController {
  ...
  async register(@Req() req: any, @Body() body: any, @UploadedFile() file: any) {
  ...
  async registerWithImage(@Req() req: any, @Body() body: any) {
  ...
  async setReferenceImage(@Req() req: any, @Param('id') id: string, @Body() body: any) {
  ...
  async clearReferenceImage(@Req() req: any, @Param('id') id: string) {
