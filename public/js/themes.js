...
(function () {
  ...
  window.DEFAULT_OFFICIAL_RECIPES = ['product-cut', 'model-cut', 'product-hero', 'jewelry-product-cut', 'jewelry-worn-cut', 'jewelry-on-model', 'jewelry-hero', 'bodywear-product-cut', 'bodywear-worn-cut', 'bodywear-hero'];
  ...
  window.OFFICIAL_THEME_MAP = {
    ...
    'bodywear-product-cut': 'bodywear', 'bodywear-worn-cut': 'bodywear', 'bodywear-hero': 'bodywear',
  };
