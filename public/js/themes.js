...
(function () {
  ...
  window.CAT_THEMES = {
    Influencer: ['people'],
    Shopping:   ['beauty', 'fashion', 'general', 'productcut', 'nail-base', 'nail-template', 'accessories', 'bodywear'],
  ...
  window.OFFICIAL_ONLY_THEMES = ['productcut', 'nail-base', 'nail-template', 'accessories', 'bodywear'];
  ...
  window.DEFAULT_OFFICIAL_RECIPES = ['product-cut', 'model-cut', 'product-hero', 'jewelry-product-cut', 'jewelry-worn-cut', 'jewelry-on-model', 'bodywear-product-cut', 'bodywear-worn-cut', 'bodywear-on-model'];
  ...
  window.OFFICIAL_THEME_MAP = {
    ...
    'jewelry-product-cut': 'accessories', 'jewelry-worn-cut': 'accessories', 'jewelry-on-model': 'accessories',
    'bodywear-product-cut': 'bodywear', 'bodywear-worn-cut': 'bodywear', 'bodywear-on-model': 'bodywear',
  };
