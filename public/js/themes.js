...
(function () {
  ...
  window.CAT_THEMES = {
    Influencer: ['people'],
    Shopping:   ['beauty', 'fashion', 'general', 'productcut', 'nail-base', 'nail-template', 'accessories', 'underwear'],
  ...
  window.OFFICIAL_ONLY_THEMES = ['productcut', 'nail-base', 'nail-template', 'accessories', 'underwear'];
  ...
  window.DEFAULT_OFFICIAL_RECIPES = ['product-cut', 'model-cut', 'product-hero', 'jewelry-product-cut', 'jewelry-worn-cut', 'jewelry-on-model', 'jewelry-hero', 'underwear-product-cut', 'underwear-hero'];
  ...
  window.OFFICIAL_THEME_MAP = {
    ...
    'underwear-product-cut': 'underwear', 'underwear-hero': 'underwear',
  };
