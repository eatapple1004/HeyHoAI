...
const PROD = {
  ...
  'jewelry-on-model-earrings': 'a natural-looking female fashion model wearing a pair of elegant unbranded gold drop earrings',
  'jewelry-on-model-necklace': 'a natural-looking female fashion model wearing a delicate unbranded gold pendant necklace on the neckline',
  'jewelry-on-model-ring':     'a natural-looking female fashion model with one hand raised near her face wearing an elegant unbranded gold diamond ring',
  'jewelry-on-model-bracelet': 'a natural-looking female fashion model with her wrist raised wearing an unbranded gold bracelet',
