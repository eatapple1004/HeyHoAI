...
const SECTIONS = [
  ...
  ['bodywear','속옷·수영복(Innerwear & Swim)','product'],
];
...
// bodywear(Innerwear & Swim): 부모 2(Product Cut·Hero) + garment axis + 파라미터형 무드 자식 → 동일 면제.
const PARAM_SECTIONS = new Set(['productcut', 'studiomodel', 'producthero', 'accessories', 'bodywear']);
