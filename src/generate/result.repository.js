...
async function insert({ promptIdx, characterId, filePath, fileSizeKb, width, height, model, metadata }) {
  const result = await query(
    `INSERT INTO generation_results (prompt_idx, character_id, file_path, file_size_kb, width, height, model, metadata)
...
module.exports = { insert, findByIdx, findByPromptIdx, findAll };
