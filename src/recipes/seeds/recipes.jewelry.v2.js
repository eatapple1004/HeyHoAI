  ...
  // ─── 1. SURFACE MACRO (generalized Facet Macro: facet OR luster) ─────────────
  {
    ...
    "config": {
      ...
      "look": {
        ...
        "extra_positive": "extreme macro product photography, 100mm macro lens at f/8 focus-stacked, lighting adapts to the surface of the uploaded piece — for faceted gemstones a dark-field pin spotlight rakes across the facets to ignite crisp internal fire and dispersion with razor-sharp facet edges; for pearls, cabochons, jade, amber, opal, wood, resin and enamel a soft raking directional light reveals luster, orient, chatoyance and natural grain without blowing out the surface; fine engraving, prongs and hallmarks tack sharp, micro-reflections on polished metal, seamless reflective base, every facet stone luster and engraving identical to the reference",
        "negative": "warped or duplicated stone, distorted prongs, melted metal, asymmetric facets, over-glossed plastic look on matte or organic surfaces, fake mirror sheen on pearls, lost luster, fingerprints, dust specks, blown-out highlights, blurry edges, extra gems, color shift on metal, text artifacts, watermark"
      },
      "shot_strategy": "list",
      "shots": [
        {
  ...
  // ─── 3. SCALE & SPEC OVERLAY (generalized Scale & Sizing: size OR spec/cert) ──
  {
    ...
    "config": {
      ...
      "look": {
        ...
        "extra_positive": "clean catalog product photography for size and spec reference, 100mm macro lens at f/11, flat soft overhead diffused light with no harsh shadows, piece placed beside a universally recognizable coin or precision ruler edge for scale OR isolated on clean negative space reserved for a spec/material badge, matte white seamless surface, the jewelry piece rendered identical to the reference in exact proportions, clinical accuracy, e-commerce info-card feel, clean uncluttered background ready for a composited badge",
        "negative": "distorted scale of product, stretched or compressed proportions, warped ruler, missing coin or reference object when scale is shown, harsh shadows obscuring edges, reflections hiding size, cluttered background, blurry edges, misleading crop, plastic sheen, color shift on metal, extra gems, duplicated piece"
      },
      "shot_strategy": "list",
      "shots": [
        {
  ...
  // ─── 5. NECK & EAR TRY-ON (NEW, on_model_tryon — off-hand try-on) ────────────
  {
    ...
    "config": {
      ...
      "look": {
        ...
        "extra_positive": "elegant on-model neck and ear jewelry photography, 85mm portrait lens at f/2.8, soft north-facing window light with a subtle silver bounce fill, well-groomed model with realistic skin texture, the necklace draped naturally on the décolletage or the earring worn on the ear lobe, the jewelry piece worn correctly and rendered identical to the reference, shallow depth of field with creamy bokeh, refined editorial styling, framing crops the face out — jaw-down for neck shots and an ear-and-jaw profile for ear shots",
        "negative": "full face in frame, distorted or asymmetric face, more than two ears, extra or duplicated earrings, floating earring detached from the lobe, malformed ear, broken or duplicated necklace chain, distorted clasp, melted or plastic skin, distorted jewelry, wrong number of stones, duplicated piece, harsh shadows, oversharpened skin, watermark"
      },
      "shot_strategy": "list",
      "shots": [
        {
  ...
  // ─── 6. SET & STACK STYLIST (NEW, multi-piece coordination flat-lay) ─────────
  {
    ...
    "config": {
      ...
      "look": {
        ...
        "extra_positive": "premium jewelry styling flat-lay, 100mm lens at f/8, soft diffused studio light, the uploaded piece coordinated into a curated multi-piece look — a ring stack on a velvet riser, layered necklaces cascading on a marble flat or neck form, a bangle or bracelet stack, or a matched parure laid out together — every instance identical to the reference, elegant negative space, lookbook styling mood, tasteful complementary props",
        "negative": "inconsistent piece identity across instances, mismatched or warped duplicates, distorted product, cluttered overcrowded composition, too many pieces, lint or hair on velvet, dust, blown highlights, gaudy props, warped reflections, plastic sheen, missing stones, text artifacts, watermark"
      },
      "shot_strategy": "list",
      "shots": [
        {
  ...
  // ─── 7. LUMEN REEL (MERGE Sparkle Snap + Light Play Reel: facet OR luster) ───
  {
    ...
    "config": {
      ...
      "look": {
        ...
        "extra_positive": "cinematic jewelry motion reel, 100mm macro look, a single controlled light bar travels across the piece — igniting rainbow facet fire and dispersion on faceted stones, or rolling soft luster, orient and chatoyance across pearls, cabochons, jade and polished metal on non-faceted pieces — deep dark reflective stage with soft falloff, the stone luster and metal finish identical to the reference, hypnotic luxury mood, ready-to-post vertical short",
        "negative": "flickering product, warped or morphing stone, jittery motion, duplicated piece, blown highlights, color banding, distorted metal, fake mirror sheen on pearls, lost luster, text artifacts, watermark, plastic look, motion smearing on edges"
      },
      "shot_strategy": "list",
      "shots": [
        {
