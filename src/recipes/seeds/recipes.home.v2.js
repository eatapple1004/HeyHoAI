...
module.exports = [
  ...
  /* ─────────────────────────────────────────────────────────────────────
   * 4. Quick Warmth Snap  (◈4 cheap reel, 2-shot)
   *    NEW — budget reel entry; satisfies ≥1 reel ≤◈6 requirement
   *    JTBD: 소규모 홈데코 브랜드 — 저비용 릴 콘텐츠, Instagram/TikTok용 단편 감성 영상
   * ─────────────────────────────────────────────────────────────────────*/
  {
    "mode": "product",
    "vertical": "home",
    "category": "Reel",
    "name": "Quick Warmth Snap",
    "output_type": "reel",
    "credit_cost": 4,
    "sort_order": 4,
    "rationale": "Small homeware and decor brands that want a short, feel-good reel without the credit commitment of a full reveal. Two shots: a soft close-up detail moment followed by a gentle pull-back to the styled product in context. Fast to generate, strong warm mood, works as a standalone post or story.",
    "meta": {
      "v2_change": "NEW template — cheap 2-shot reel fills the ≤◈6 reel budget tier"
    },
    "config": {
      "schema_version": 1,
      "mode": "product",
      ...
      "look": {
        "style_preset": "Film",
        "attributes": [
          "lighting:golden_hour_soft_window",
          "color:warm_amber_greige",
          "texture:soft_grain_linen_wood",
          "context:cozy_home_vignette"
        ],
        "extra_positive": "short cinematic home reel, 50mm lens at f/2.0, warm afternoon window light, soft shallow depth of field with creamy bokeh, cozy home vignette, linen and natural wood surfaces, product kept exact in shape/material/color, buttery smooth gentle motion, aspirational lifestyle home mood",
        "negative": "fast jerky motion, warped or duplicated product, harsh flash, cold blue cast, blown-out window, text artifacts, watermark, logos, plastic CGI look, distorted proportions, flicker, morphing surfaces"
      },
      "shot_strategy": "list",
      "shots": [
        {
          "scene": "warm windowsill or wooden side table, golden light, soft bokeh background",
          "pose": "product close-up detail shot bathed in warm afternoon light",
          "composition": "closeup"
        },
        {
          "scene": "same warm corner, gentle pull-back revealing full product and cozy styled context with a linen throw and plant",
          "pose": "product full view in warm aspirational setting",
          "composition": "medium_shot"
        }
      ],
      "reel": {
        "per_shot_motion": [
          "slow gentle push-in toward the warm product detail",
          "smooth pull-back revealing the styled warm room context"
        ],
        "duration_per_shot": 3,
        "transition": "fade",
        "music_mood": "warm lo-fi chill",
        "captions": "auto"
      },
      "provider": {
        "image": "nano-banana",
