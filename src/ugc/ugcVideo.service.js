 ...
 */
async function generateScript({ product, concept, outputType = 'product-ad', image = null, details = '', voiceover = true }) {
  if (!concept) { const e = new Error('concept is required'); e.statusCode = 400; throw e; }
  const script = await generateUgcScript({ product, concept, outputType, image, details, voiceover });
